...
//typedef struct log_out_t log_out;
//****************************************************************************************************************************************************//
...
//		sprintf (UART3_msg_TX,"%x %x %x %x\r\n", RS485_TXbuffer [0], RS485_TXbuffer [1], RS485_TXbuffer [2], RS485_TXbuffer [3]);
//		UART3_SendString ((char*)UART3_msg_TX);	
		...
		{	
			...
			memcpy (*(ptr_cell+count), (ptr_RS485_msg+1), 5); //копирование 5 символов сообщения от ячейки, в массив с данными от ячеек  
		}	
